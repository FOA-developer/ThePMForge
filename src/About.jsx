const About = () => {
  return ( 
    <div className="text-white bg-[rgb(2,44,83)] flex flex-col gap-6 pt-6 justify-center items-center pb-15">
      <div className=" border-white border-b-1 border-l-1 w-[60%]">

      </div>
      <div className="m-auto w-[80%] text-left">
