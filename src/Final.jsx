const Final = () => {
  return ( 
    <div className = "flex flex-col justify-center text-center pt-20 items-center text-[rgb(11,41,95)] pb-24">
      <div className="flex w-[80%] flex-col">
        <h3 className="font-inter font-semibold text-xs ">READY TO JOIN</h3>
        <h1 className="font-display font-bold text-2xl pt-5 md:text-3xl text-4xl">Join a curated network focused <span className="font-display italic">real execution.</span></h1>
