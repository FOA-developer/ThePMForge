const Home = () => {
  return ( 
    <div className = "pt-20 pl-6 pr-2 bg-[rgb(248,249,250)] pb-24">
      ...
      <p className="font-inter pt-4 text-sm text-[rgb(1,104,126)]">ThePMForge brings together experienced project and program leaders to uncover real execution breakdowns—and turn them into practical frameworks, insights, and solutions for better delivery.</p>
