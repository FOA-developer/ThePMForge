const Home = () => {
  return ( 
    <div className = "pt-20 pl-6 pr-2 bg-[rgb(248,249,250)] pb-24">
      ...
      <h1 className="font-display font-bold text-4xl pt-5 text-[rgb(1,104,126)]">Execution fails more than <span className="">strategy. We study</span><span className="font-display italic"> why.</span></h1>
