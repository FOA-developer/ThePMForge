...
const Navbar = () => {
  ...
  return ( 
    <nav className = "flex flex-row justify-between items-center p-4 text-[rgb(11,41,95)]">
      ...
      <div>
        <ul className="list-none flex gap-8 flex-row items-center">
          ...
          <li><a href="" target="_blank" rel="noopener noreferrer"><button className="text-xs font-semi-bold bg-[rgb(11,41,95)] hover:bg-[rgb(39, 198, 230)]font-inter text-white p-3 rounded-full transition-all duration-600 ease-out transform hover:scale-105 active:scale-95 ">Request an Invite</button></a></li>
        </ul>
      </div>
    </nav>
   );
